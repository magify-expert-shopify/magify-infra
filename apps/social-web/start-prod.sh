...
IMAGE_NAME="magify-social-web:prod"
# IMAGE_NAME="ghcr.io/magify-expert-shopify/magify-social-web:latest"
...
docker build \
  -f "$REPO_ROOT/apps/social-web/Dockerfile.prod" \
  "${build_args[@]}" \
  -t "$IMAGE_NAME" \
  "$REPO_ROOT"
