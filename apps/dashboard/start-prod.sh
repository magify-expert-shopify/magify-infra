...
# IMAGE_NAME="ghcr.io/magify-expert-shopify/dashboard:latest"
IMAGE_NAME="magify-dashboard:prod"
...
docker build \
  -f "$REPO_ROOT/apps/dashboard/Dockerfile.prod" \
  "${build_args[@]}" \
  -t "$IMAGE_NAME" \
  "$REPO_ROOT"
