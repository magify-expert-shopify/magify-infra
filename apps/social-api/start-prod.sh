...
IMAGE_NAME="magify-social-api:prod"
# IMAGE_NAME="ghcr.io/magify-expert-shopify/magify-social-api:latest"
...
docker build \
  -f "$REPO_ROOT/apps/social-api/Dockerfile.prod" \
  "${build_args[@]}" \
  -t "$IMAGE_NAME" \
  "$REPO_ROOT"
